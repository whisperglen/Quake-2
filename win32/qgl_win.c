...
void ( APIENTRY * qglPopDebugGroup )(void);
...
void ( APIENTRY * qglPushDebugGroup )(GLenum source, GLuint id, GLsizei length, const GLbyte *message);
...
static void ( APIENTRY * dllPopDebugGroup )(void);
...
static void ( APIENTRY * dllPushDebugGroup )(GLenum source, GLuint id, GLsizei length, const GLbyte *message);
...
qboolean QGL_Init( const char *dllname )
{
	...
	qglPopDebugGroup             = 	dllPopDebugGroup             = GPA( "glPopDebugGroup" );
	...
	qglPushDebugGroup            = 	dllPushDebugGroup            = GPA( "glPushDebugGroup" );
